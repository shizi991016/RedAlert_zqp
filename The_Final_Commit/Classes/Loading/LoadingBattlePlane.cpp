...
void GameScene::battlePlaneBuildCallBack()
{
    auto BuildingSprite = BuildingsClass::createWithSpriteFileName("ArmyAction/OneBattlePlane_action/OneBattlePlane_action_up_1.png");
    ...
    MyData.MyBattlePlane.push_back(BuildingSprite);
    ...
    ("ArmyAction/OneBattlePlane_action/OneBattlePlane_action_up_1.png");
    FinishBuildAnimation->addSpriteFrameWithFile
    ("ArmyAction/OneBattlePlane_action/OneBattlePlane_action_up_2.png");
            ...
            [(int)MyData.ArmyLastTouchPosition.x][(int)MyData.ArmyLastTouchPosition.y])
        {
                ...
                (MyData.ArmyLastTouchPosition.y-MyData.ArmyFirstTouchPosition.y) <= 150*150)
            {
                ...
                (IsPositionHaveArmyAndTag
                 [(int)MyData.ArmyLastTouchPosition.x][(int)MyData.ArmyLastTouchPosition.y]);
                BuildingSprite->setLifeValue(BuildingSprite->getLifeValue()-30);
                LoadingBar* HPBar = (LoadingBar*)this->getChildByTag(BuildingSprite->getTag()+1);
                HPBar->setPercent(HPBar->getPercent()-30);
...
Action* GameScene::BattlePlaneMoveUp(int ActionTime)
{
    auto animation = Animation::create();
    animation->addSpriteFrameWithFile("ArmyAction/OneBattlePlane_action/OneBattlePlane_action_up_1.png");
    animation->addSpriteFrameWithFile("ArmyAction/OneBattlePlane_action/OneBattlePlane_action_up_2.png");
...
Action* GameScene::BattlePlaneMoveLeft(int ActionTime)
{
    auto animation = Animation::create();
    animation->addSpriteFrameWithFile("ArmyAction/OneBattlePlane_action/OneBattlePlane_action_left_1.png");
    animation->addSpriteFrameWithFile("ArmyAction/OneBattlePlane_action/OneBattlePlane_action_left_2.png");
    animation->setLoops(ActionTime);
    animation->setDelayPerUnit(1.0f/2.0f);
    animation->setRestoreOriginalFrame(false);
    auto action = Animate::create(animation);
...
Action* GameScene::BattlePlaneMoveRight(int ActionTime)
{
    auto animation = Animation::create();
    animation->addSpriteFrameWithFile("ArmyAction/OneBattlePlane_action/OneBattlePlane_action_right_1.png");
    animation->addSpriteFrameWithFile("ArmyAction/OneBattlePlane_action/OneBattlePlane_action_right_2.png");
    animation->setLoops(ActionTime);
    animation->setDelayPerUnit(1.0f/2.0f);
    animation->setRestoreOriginalFrame(false);
    auto action = Animate::create(animation);
...
Action* GameScene::BattlePlaneMoveDown(int ActionTime)
{
    auto animation = Animation::create();
    animation->addSpriteFrameWithFile("ArmyAction/OneBattlePlane_action/OneBattlePlane_action_down_1.png");
    animation->addSpriteFrameWithFile("ArmyAction/OneBattlePlane_action/OneBattlePlane_action_down_2.png");
    animation->setLoops(ActionTime);
    animation->setDelayPerUnit(1.0f/2.0f);
    animation->setRestoreOriginalFrame(false);
    auto action = Animate::create(animation);
...
void GameScene::emenyBattlePlaneBuildCallBack(int Tag)
{
    auto BuildingSprite = BuildingsClass::createWithSpriteFileName("ArmyAction/OneBattlePlane_action/OneBattlePlane_action_up_1.png");
