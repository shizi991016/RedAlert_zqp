...
void GameScene::emenyElectricPowerPlantBuildCallBack(int Tag)
{
    auto BuildingSprite = BuildingsClass::createWithSpriteFileName("ArmyAction/CommonElectricPowerPlant_action/CommonElectricPowerPlant_action_14.png");
    BuildingSprite->setPosition(MyData.LastTouchPosition);
    this->addChild(BuildingSprite,1);
    BuildingSprite->runAction(loadingElectricPowerPlantAction());
