...
{
    auto BuildingSprite = BuildingsClass::createWithSpriteFileName("ArmyAction/CommonDog_action/CommonDog_action_up_1.png");
    ...
    MyData.MyDog.push_back(BuildingSprite);
...
Action* GameScene::DogMoveLeft(int ActionTime)
{
    ...
    ("ArmyAction/CommonDog_action/CommonDog_action_left_1.png");
    animation->addSpriteFrameWithFile
    ("ArmyAction/CommonDog_action/CommonDog_action_left_2.png");
...
Action* GameScene::DogMoveRight(int ActionTime)
{
    auto animation = Animation::create();
    animation->addSpriteFrameWithFile
    ("ArmyAction/CommonDog_action/CommonDog_action_right_1.png");
    animation->addSpriteFrameWithFile
    ("ArmyAction/CommonDog_action/CommonDog_action_right_2.png");
    animation->setLoops(ActionTime);
    animation->setDelayPerUnit(1.0f/4.0f);
    animation->setRestoreOriginalFrame(false);
    auto action = Animate::create(animation);
...
Action* GameScene::DogMoveDown(int ActionTime)
{
    auto animation = Animation::create();
    animation->addSpriteFrameWithFile
    ("ArmyAction/CommonDog_action/CommonDog_action_down_1.png");
    animation->addSpriteFrameWithFile
    ("ArmyAction/CommonDog_action/CommonDog_action_down_2.png");
    animation->setLoops(ActionTime);
    animation->setDelayPerUnit(1.0f/4.0f);
    animation->setRestoreOriginalFrame(false);
    auto action = Animate::create(animation);
...
void GameScene::emenyDogBuildCallBack(int Tag)
{
    auto BuildingSprite = BuildingsClass::createWithSpriteFileName("ArmyAction/CommonDog_action/CommonDog_action_up_1.png");
