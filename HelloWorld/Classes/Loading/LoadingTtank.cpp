...
void GameScene::tTankBuildCallBack()
{
    auto BuildingSprite = BuildingsClass::createWithSpriteFileName("ArmyAction/TwoTtank_action/TwoTtank_action_up_1.png");
    ...
    MyData.MyTTank.push_back(BuildingSprite);
    ...
    ("ArmyAction/TwoTtank_action/TwoTtank_action_up_1.png");
    FinishBuildAnimation->addSpriteFrameWithFile
    ("ArmyAction/TwoTtank_action/TwoTtank_action_up_2.png");
    ...
    stream << MyData.TagNumber << " " << "*" << (int)MyData.ArmyLastTouchPosition.x << "*" << "/" << (int)MyData.ArmyLastTouchPosition.y+100 << "/";
    std::string order = stream.str();
    //std::string MyOrder = "1bh ";
    MyOrder += order;
            ...
            [(int)MyData.ArmyLastTouchPosition.x][(int)MyData.ArmyLastTouchPosition.y])
        {
                ...
                (MyData.ArmyLastTouchPosition.y-MyData.ArmyFirstTouchPosition.y) <= 150*150)
            {
                ...
                (IsPositionHaveArmyAndTag
                 [(int)MyData.ArmyLastTouchPosition.x][(int)MyData.ArmyLastTouchPosition.y]);
                BuildingSprite->setLifeValue(BuildingSprite->getLifeValue()-50);
                LoadingBar* HPBar = (LoadingBar*)this->getChildByTag(BuildingSprite->getTag()+1);
                HPBar->setPercent(HPBar->getPercent()-50);
        ...
        else
        {
            ...
            else
            {
                ...
                * (MyData.ArmyLastTouchPosition.y - Position.y);
                ...
                MyOrder += "mh ";
                std::stringstream stream;
                stream << Tag << " " << "*" << (int)MyData.TheLastWarFactoryPosition.x << "*" << "/" << (int)MyData.TheLastWarFactoryPosition.y+100 << "/";
                std::string order = stream.str();
                //std::string MyOrder = "1ah ";
                MyOrder += order;
                MyOrderList.push_back(MyOrder);
...
Action* GameScene::TTankMoveUp(int ActionTime)
{
    auto animation = Animation::create();
    animation->addSpriteFrameWithFile("ArmyAction/TwoTtank_action/TwoTtank_action_up_1.png");
    animation->addSpriteFrameWithFile("ArmyAction/TwoTtank_action/TwoTtank_action_up_2.png");
...
Action* GameScene::TTankMoveLeft(int ActionTime)
{
    auto animation = Animation::create();
    animation->addSpriteFrameWithFile("ArmyAction/TwoTtank_action/TwoTtank_action_left_1.png");
    animation->addSpriteFrameWithFile("ArmyAction/TwoTtank_action/TwoTtank_action_left_2.png");
    animation->setLoops(ActionTime);
    animation->setDelayPerUnit(1.0f/2.0f);
    animation->setRestoreOriginalFrame(false);
    auto action = Animate::create(animation);
...
Action* GameScene::TTankMoveRight(int ActionTime)
{
    auto animation = Animation::create();
    animation->addSpriteFrameWithFile("ArmyAction/TwoTtank_action/TwoTtank_action_right_1.png");
    animation->addSpriteFrameWithFile("ArmyAction/TwoTtank_action/TwoTtank_action_right_2.png");
    animation->setLoops(ActionTime);
    animation->setDelayPerUnit(1.0f/2.0f);
    animation->setRestoreOriginalFrame(false);
    auto action = Animate::create(animation);
...
Action* GameScene::TTankMoveDown(int ActionTime)
{
    auto animation = Animation::create();
    animation->addSpriteFrameWithFile("ArmyAction/TwoTtank_action/TwoTtank_action_down_1.png");
    animation->addSpriteFrameWithFile("ArmyAction/TwoTtank_action/TwoTtank_action_down_2.png");
    animation->setLoops(ActionTime);
    animation->setDelayPerUnit(1.0f/2.0f);
    animation->setRestoreOriginalFrame(false);
    auto action = Animate::create(animation);
...
void GameScene::emenyTTankBuildCallBack(int Tag)
{
    auto BuildingSprite = BuildingsClass::createWithSpriteFileName("ArmyAction/TwoTtank_action/TwoTtank_action_up_1.png");
